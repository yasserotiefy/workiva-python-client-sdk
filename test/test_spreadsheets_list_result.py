...
class TestSpreadsheetsListResult(unittest.TestCase):
    """SpreadsheetsListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpreadsheetsListResult:
        """Test SpreadsheetsListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpreadsheetsListResult`
        """
        model = SpreadsheetsListResult()
        if include_optional:
            return SpreadsheetsListResult(
                data = [
                    openapi_client.models.spreadsheet.Spreadsheet(
    ...
    def testSpreadsheetsListResult(self):
        """Test SpreadsheetsListResult"""
