...
class TestTasksListResult(unittest.TestCase):
    """TasksListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TasksListResult:
        """Test TasksListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TasksListResult`
        """
        model = TasksListResult()
        if include_optional:
