...
class TestApplyFormats(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApplyFormats:
        """Test ApplyFormats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplyFormats`
        """
        model = ApplyFormats()
        if include_optional:
            return ApplyFormats(
