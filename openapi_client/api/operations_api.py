...
class OperationsApi:
    ...
    def get_operation_by_id(
        self,
        operation_id: Annotated[StrictStr, Field(description="The unique identifier of the operation")],
        ...
        :param operation_id: The unique identifier of the operation (required)
        ...
        _param = self._get_operation_by_id_serialize(
    ...
    @validate_call
    def get_operation_by_id_with_http_info(
        self,
        operation_id: Annotated[StrictStr, Field(description="The unique identifier of the operation")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_operation_by_id_without_preload_content(
        self,
        operation_id: Annotated[StrictStr, Field(description="The unique identifier of the operation")],
        _request_timeout: Union[
            None,
    ...
    def _get_operation_by_id_serialize(
        self,
        operation_id,
        _request_auth,
        _content_type,
