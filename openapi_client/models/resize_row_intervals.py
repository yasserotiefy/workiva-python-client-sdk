...
class ResizeRowIntervals(BaseModel):
    ...
    """ # noqa: E501
    size: Annotated[int, Field(le=10000, strict=True, ge=3)] = Field(description="The new size for the rows, in points")
    intervals: List[Interval] = Field(description="The intervals of rows to resize")
