...
class TestFormsListResult(BaseModel):
    ...
    """ # noqa: E501
    data: List[TestForm] = Field(description="A list of `Matrix` objects")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [TestForm.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
