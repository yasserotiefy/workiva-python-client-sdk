...
class RangeValuesListResult(BaseModel):
    ...
    next_link: Optional[StrictStr] = Field(default=None, description="Pagination link for next set of results", alias="@nextLink")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [RangeValues.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
