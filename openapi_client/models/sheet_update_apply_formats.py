...
class SheetUpdateApplyFormats(BaseModel):
    ...
    """ # noqa: E501
    formats: List[ApplyFormats] = Field(description="The list of formats to apply to the sheet")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "formats": [ApplyFormats.from_dict(_item) for _item in obj["formats"]] if obj.get("formats") is not None else None
        })
        return _obj
