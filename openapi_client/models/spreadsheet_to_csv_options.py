...
class SpreadsheetToCsvOptions(BaseModel):
    ...
    """ # noqa: E501
    export_as_formulas: Optional[StrictBool] = Field(default=False, description="Whether to export cells containing formulas as the formula or the formula result. False by default.", alias="exportAsFormulas")
    __properties: ClassVar[List[str]] = ["exportAsFormulas"]
