...
class TestPhasesListResult(BaseModel):
    ...
    """ # noqa: E501
    data: List[TestPhase] = Field(description="A list of `TestPhase` objects")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [TestPhase.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
