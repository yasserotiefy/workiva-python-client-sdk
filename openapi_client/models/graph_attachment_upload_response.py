...
class GraphAttachmentUploadResponse(BaseModel):
    ...
    """ # noqa: E501
    upload_url: Optional[StrictStr] = Field(default=None, description="The URL to make a PUT request to, to upload the attachment. Include the file content of the attachment as the body of the request. This is a temporary URL; it should be used immediately when the response is received. ", alias="uploadUrl")
