...
class GraphAttachmentsListResult(BaseModel):
    ...
    """ # noqa: E501
    data: List[GraphAttachment] = Field(description="A list of `GraphAttachment` objects")
    next_link: Optional[StrictStr] = Field(default=None, description="The pagination link for next set of results", alias="@nextLink")
    __properties: ClassVar[List[str]] = ["data", "@nextLink"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [GraphAttachment.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
