...
class DocumentToPdfOptions(BaseModel):
    ...
    include_alternate_row_fill: Optional[StrictBool] = Field(default=False, description="Whether to include alternate row fill when exporting to .PDF. False by default.", alias="includeAlternateRowFill")
    ...
    include_attachment_labels: Optional[StrictBool] = Field(default=False, description="Whether to include attachment labels when exporting to .PDF. False by default.", alias="includeAttachmentLabels")
    ...
    __properties: ClassVar[List[str]] = ["includeHyperlinks", "includeLeaderDots", "includeAlternateRowFill", "tagForWebAccessibility", "includeAttachmentLabels", "useCmykColorspace", "includeDraftWatermark", "includeComments", "includeTrackChanges"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "includeAttachmentLabels": obj.get("includeAttachmentLabels") if obj.get("includeAttachmentLabels") is not None else False,
