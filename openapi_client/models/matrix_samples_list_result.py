...
class MatrixSamplesListResult(BaseModel):
    ...
    """ # noqa: E501
    data: List[MatrixSample] = Field(description="A list of `MatrixSample` objects")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [MatrixSample.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
