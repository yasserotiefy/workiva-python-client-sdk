...
class Document(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Name of the document")
    template: Optional[StrictBool] = Field(default=None, description="Whether the document is a template")
    created: Optional[Action] = None
    modified: Optional[Action] = None
    sections: Optional[List[Section]] = Field(default=None, description="An array of information about the sections in the document. Included in the response only when the $expand query parameter is provided. ")
    __properties: ClassVar[List[str]] = ["id", "name", "template", "created", "modified", "sections"]
