...
class GraphAttachment(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the graph attachment")
    file_name: Optional[StrictStr] = Field(default=None, description="The filename of the graph attachment", alias="fileName")
