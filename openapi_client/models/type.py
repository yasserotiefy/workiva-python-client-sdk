...
class Type(BaseModel):
    ...
    Type
    """ # noqa: E501
    id: StrictStr = Field(description="The unique name of the record type")
    properties: List[StrictStr] = Field(description="The list of properties related to this record type")
    relationships: Optional[List[Relationship]] = Field(default=None, description="An array of relationships that exist with this type")
    __properties: ClassVar[List[str]] = ["id", "properties", "relationships"]
